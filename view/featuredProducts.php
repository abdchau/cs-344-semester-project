<?php require '../model/interface.php';
  ...
  $featuredProds = getFeaturedProducts($conn, false);
?>

<!doctype html>
<html lang="en">
<?php echo loadHeader('Featured products'); ?>

  <body ng-app="PageApp">
	<?php echo loadNavbar(getCategories($conn), getUserJson($conn)); ?>


	<div class="album py-5 bg-light" ng-controller="productInfoControl">
		<div class="container card shadow-lg">
			<h3 class="display-4 mb-5 mr-auto">Featured Products</h3>
            <div class="row">
    ...
    <script>
      App.controller('productInfoControl', function ($scope){
      $scope.products = JSON.parse('<?php echo $featuredProds ?>');
      });
    </script>
    </body>
</html>